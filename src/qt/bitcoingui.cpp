...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zetacoin: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Zetacoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Zetacoin Core"), this);
    ...
    openAction->setStatusTip(tr("Open a zetacoin: URI or payment request"));
